				...
				try:
					with open("sitelist.txt","a") as f:
						...
						if "go.microsoft.com" in site:
							pass
						elif ".wordpress." in site:
							pass
						elif ".blogspot." in site:
							pass
							...
							pass
						elif "pastebin.com" in site:
							pass
						elif "vulners.com" in site:
							pass
						elif "stackoverflow.com" in site:
							pass
						elif "google-dorking.com" in site:
							pass
						elif ".opencart." in site:
							pass
						elif ".wikipedia." in site:
							pass
						elif "exploit-db.com" in site:
							pass
						elif ".opencart." in site:
							pass
						elif ".hash." in site:
